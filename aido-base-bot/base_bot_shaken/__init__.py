...
from base_bot_shaken.extensions.chromium_extension import ChromiumExtension
from base_bot_shaken.extensions.pdf_save_extension import PDFExtension
from base_bot_shaken.extensions.map_extension import WebpageScreenshotExtension

from base_bot_shaken.llm_bot_base import LLMBotBase

class BaseBotShaken(LLMBotBase):
